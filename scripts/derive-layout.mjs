...
// The annular streets are concentric about the Man, so fitting circles to them
// recovers the same point the survey marks directly. Agreement between the two
// is what says this derivation is reading the data correctly.
...
// --- The rotation ---------------------------------------------------------
// Every radial is a clock position, so each one implies the same city rotation.
